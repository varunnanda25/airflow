...
def read_csv_file():
    ...
    print(df.head())
    return df.to_json()  #returning dataframe as json object
...
read_csv_file_task >> remove_null_values_task >> determine_branch_task>>[filter_by_northeast_task,
                                                                         filter_by_northwest_task,
                                                                         filter_by_southeast_task, 
                                                                         filter_by_southwest_task, 
                                                                         groupby_region_smoker_task]
